...
@Database(
    entities = [Person::class, HouseDetails::class, SupplyItem::class],
    version = 3,
    exportSchema = false
)
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_2_3 = object : Migration(2, 3) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE `supply_items` ADD COLUMN `sortOrder` INTEGER NOT NULL DEFAULT 0")
            }
        }
